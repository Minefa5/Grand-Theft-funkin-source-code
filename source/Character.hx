...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
	        ...
	        case 'claude':
			    tex = Paths.getSparrowAtlas('claude_assets');
			    frames = tex;
			    animation.addByPrefix('idle', 'claude idle', 24, false);
				animation.addByPrefix('singUP', 'claude up', 24, false);
				animation.addByPrefix('singRIGHT', 'claude right', 24, false);
				animation.addByPrefix('singDOWN', 'claude down', 24, false);
				animation.addByPrefix('singLEFT', 'claude left', 24, false);
